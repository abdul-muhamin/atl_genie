...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langchain$2f$document$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_import__("[project]/node_modules/langchain/document.js [app-route] (ecmascript) <module evaluation>");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langchain$2f$util$2f$document$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_import__("[project]/node_modules/langchain/util/document.js [app-route] (ecmascript) <module evaluation>");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$server$2d$only$2f$empty$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/dist/compiled/server-only/empty.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$gomomento$2f$sdk$2f$dist$2f$src$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@gomomento/sdk/dist/src/index.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$langchain$2f$community$2f$caches$2f$momento$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_import__("[project]/node_modules/@langchain/community/caches/momento.js [app-route] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$langchain$2f$community$2f$dist$2f$caches$2f$momento$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@langchain/community/dist/caches/momento.js [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langchain$2f$output_parsers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_import__("[project]/node_modules/langchain/output_parsers.js [app-route] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langchain$2f$dist$2f$output_parsers$2f$http_response$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/langchain/dist/output_parsers/http_response.js [app-route] (ecmascript)");
...
`;
const questionPrompt = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$langchain$2f$core$2f$dist$2f$prompts$2f$prompt$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PromptTemplate"].fromTemplate(`Use the following pieces of context to answer the question at the end.
----------
...
async function initializeCache() {
    try {
        const client = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$gomomento$2f$sdk$2f$dist$2f$src$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CacheClient"]({
            configuration: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$gomomento$2f$sdk$2f$dist$2f$src$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Configurations"].Laptop.v1(),
            credentialProvider: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$gomomento$2f$sdk$2f$dist$2f$src$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CredentialProvider"].fromEnvironmentVariable({
                environmentVariableName: 'MOMENTO_API_KEY'
            }),
            defaultTtlSeconds: 60 * 60 * 24
        });
        const cache = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$langchain$2f$community$2f$dist$2f$caches$2f$momento$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MomentoCache"].fromProps({
            client,
...
const getMeetingTool = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$langchain$2f$core$2f$dist$2f$tools$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tool"])(async ()=>{
    return 'BOOK_MEETING';
}, {
...
const getChain = async (apiKey)=>{
    const parser = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langchain$2f$dist$2f$output_parsers$2f$http_response$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["HttpResponseOutputParser"]();
    // Try to initialize cache, but continue without it if it fails
    const cache = await initializeCache().catch(()=>null);
    const chatModel = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$langchain$2f$openai$2f$dist$2f$chat_models$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChatOpenAI"]({
        ...cache && {
            cache
        },
        apiKey,
    ...
    return new ReadableStream({
        async start (controller) {
            ...
            if (idArray[0] !== null) {
                ...
                serializedDocs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$langchain$2f$dist$2f$util$2f$document$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["formatDocumentsAsString"])(docs.matches.map((doc)=>new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$langchain$2f$core$2f$dist$2f$documents$2f$document$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Document"]({
...
//# sourceMappingURL=src_97125f._.js.map